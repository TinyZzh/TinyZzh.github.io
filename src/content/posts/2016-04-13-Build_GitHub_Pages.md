...
**[2016-10-09 补充]**[升级 Jekyll 到 3.2](/posts/2016-10-09-Build_GitHub_Pages_Update/)
...
![Ruby环境安装包](/images/2016-04/s1.png){: style="float:none"}

Ruby DevKit 安装包：

![Ruby DevKit安装包](/images/2016-04/s2.png)

安装完成后打开命令行(或 Win + R, 输入 cmd 回车)输入 ruby -version ：

![检查](/images/2016-04/s3.jpg)
...
![Jekyll安装成功](/images/2016-04/s4.jpg)

![检查Jekyll安装成功](/images/2016-04/s5.jpg)
