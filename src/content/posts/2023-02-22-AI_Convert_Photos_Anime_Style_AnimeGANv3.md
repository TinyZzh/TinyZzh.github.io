...
<div align="center"><img src="/images/2023-02/AnimeGANv2.jpg" alt="生成器网络的架构" width="650px" height="400px"/></div>
...
手机扫描下方二维码打开
<div align="center"><img src="/images/2023-02/AnimeGANv3_phone_code.png" alt="官网Demo" width="650px" height="400px"/></div>

### 使用示例

<div align="center"><img src="/images/2023-02/AnimeGANv3_use_case1.png" alt="使用示例" width="650px" height="400px"/></div>

可以选择转换结果的风格，内置提供以下8种风格的输出。

<div align="center"><img src="/images/2023-02/AnimeGANv3_use_case2.png" alt="使用示例" width="650px" height="400px"/></div>

分别对应 **宫崎骏、新海诚、双城之战、迪士尼卡通、美式卡通、漫画、北欧神话、肖像速写**八种风格。

展示转换结果图

<div align="center"><img src="/images/2023-02/AnimeGANv3_use_case3.png" alt="使用示例" width="650px" height="400px"/></div>
